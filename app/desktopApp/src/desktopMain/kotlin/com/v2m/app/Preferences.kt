 ...
 *  detectKey and the last used file paths. Stored as a properties file in
 *  ~/.v2m/prefs.properties — the desktop equivalent of Android
 *  SharedPreferences, without extra dependencies. */
object Preferences {
    private val file = File(System.getProperty("user.home"), ".v2m" + File.separator + "prefs.properties")

    data class Loaded(
        val params: V2mEngine.Params,
        val detectKey: Boolean,
    ...
    fun load(): Loaded {
        ...
        return Loaded(
            params = V2mEngine.Params(
                ...
                tempoBpm = f("tempoBpm", def.tempoBpm, 0f, 300f),
    ...
    fun save(
        ...
        p.setProperty("detectKey", detectKey.toString())
